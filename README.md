...
# 🚀 Day 1: Getting Started with .NET and C#

📅 **Date:** 18 December 2025
🎯 **Goal:** Understand the fundamentals of the .NET platform and C# language

---

## ✨ Overview

Day 1 focused on building a strong foundation by understanding **what .NET is**, **why C# is used**, and **how code actually runs behind the scenes**.

---

## 📌 Key Learnings

* 🔹 Introduction to the **.NET platform** and its real-world use cases
* 🔹 Basics of the **C# programming language** and its role in .NET
* 🔹 Environment setup using **Visual Studio** and **.NET SDK 8**

---

## ⚙ How C# Code Executes

1. C# source code is compiled into **Intermediate Language (IL)**
2. IL is executed at runtime by the **Common Language Runtime (CLR)**
3. CLR handles:
...
🔍 Also discussed the **Compiler vs Interpreter** concept for better clarity.

---

## 🛠 Best Practices & Insights

* 📈 Evolution of **C# versions** and language improvements over time
* 🧾 Importance of **naming conventions** in code
...
Strengthened understanding of implicit vs explicit type casting

Reviewed memory structure and execution flow of a C# program
...
Understood looping mechanisms including for, while, and do-while

Introduction to jump statements like break, continue, and return
...
Understood how to build and run a C# console application

Explained the entry point of a C# application (Main method / top-level statements)
...
Studied how arrays hold elements of a single data type
...
Focused more on implementation and logic building rather than theory
...
Strengthened understanding through repeated coding and implementation
...
Compared string literals with strings created using the new keyword
...
Traversal and logic-based modifications

Strengthened understanding through continuous hands-on coding
...
Practiced writing clean, modular methods for problem solutions
